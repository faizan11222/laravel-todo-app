...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.19.0/moment.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        for (let i = 0; i < date.length; i++) {
            ...
            console.log(current);
            $("#append").append("<tr><td>"+title[i]+"</td><td>"+desc[i]+"</td><td>"+current.toTimeString()+"</td><td>"+status+"</td>   <td> <a href='/todos/"+id[i]+"/edit' class='btn btn-success'><i class='far fa-edit text-white'>Edit</a></i></td></tr>")
